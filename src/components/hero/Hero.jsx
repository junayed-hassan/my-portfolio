...
function Hero() {
  return (
    <div className='hero flex items-center gap-9 flex-col font-Lora'>
        ...
        <div className='hero-action flex items-center gap-6 text-2xl font-medium mb-12'>
            <div className='hero-connect py-6 px-10 rounded-[50px] cursor-pointer bg-gradient-to-r to-violet-500 from-pink-500 text-fuchsia-100'>Connect With Me</div>
