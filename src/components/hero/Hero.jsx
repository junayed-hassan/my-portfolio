...
function Hero() {
  return (
    <div id='home' className='hero flex items-center gap-6  max-[448px]:gap-3 flex-col font-Lora mt-20 max-[448px]:mt-10'>
        ...
        <h1 className='text-center sm:w-[450px] sm:text-4xl max-[448px]:w-[300px] lg:w-[870px] lg:text-7xl md:text-5xl max-[448px]:text-2xl  font-semibold md:w-[650px] '><span className='bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500'>I am Junayed Hasan</span> frontend developer based in Bangladesh </h1>
        <p className='lg:w-[650px] md:w-[490px] sm:w-[430px] max-[448px]:w-[270px] max-[448px]:text-xs text-center lg:text-xl md:text-base sm:text-sm leading-10'>I am a frontend developer from Dhaka with 10 years of experience in multiple companies like Microsoft, Tesla and Apple.</p>
